...
The detailed, machine-readable manifest is in `en_only_removal_manifest.csv`. A match is not an instruction to delete: campaign data, attribution, and shared geometry/assets are reviewed before action.

...
class GeneratedConfig:
    ...
    Emulator_PackageName = 'auto'  # auto, com.YoStarEN.AzurLane
    Emulator_ServerName = 'disabled'  # disabled, en-0, en-1, en-2, en-3, en-4, en-5
    ...
    DropRecord_OpsiRecord = 'do_not'  # do_not, save
